...
const textFetch = (studentSummary, student) => {
  console.log(JSON.stringify(studentSummary));
  const params = new URLSearchParams();
  params.append('From', '+15024132624');
  params.append('To', '+15029052136');
  params.append('Body', ` ${student} just earned a value point for demonstrating ${studentSummary}!`);
  return axios.post(
