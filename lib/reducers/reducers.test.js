import coreValueReducer from './CoreValueReducer.js';
...
describe('corevalue reducer', () => {
  ...
  it('should have a default state', () => {
    ...
    expect(coreValueReducer(undefined, {})).toEqual(coreValueData);
  });
  ...
  it('should add a core value when given info', () => {
    ...
    expect(coreValueReducer(undefined, action.type)).toEqual(coreValueData, action.newValue);
  });
  ...
  it('should add a new set of core values', () => {
    ...
    expect(coreValueReducer(undefined, action.type)).toEqual(coreValueData, action.newSet);
  ...
  it('should increment core values', () => {
    ...
    expect(coreValueReducer(undefined, action.type)).toEqual(coreValueData, action.coreValue);
  });
});
