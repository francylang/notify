const initialState = {
  ...
  students: [
    ...
    {id: 13, name: 'Jonathan Beckman', parentContact: 'Sally Beckman', phone: '444-333-3211'},
    ...
    {id: 20, name: 'Hudson Lynam', parentContact: 'Sally Lynam', phone: '444-333-3211'}
...
const classReducer = (state = initialState, action) => {
  switch (action.type) {
    // case 'NEW_TEACHER':
    //   const pushNewTeacher = state.teacher.push(action.newTeacher)
    //   const newState = { teacher: pushNewTeacher, students: state.students }
    //
...
export default { classReducer, initialState };
