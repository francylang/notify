  ...
  const classroomContents = (
    <div className='header-home'>
      ...
      <div className='character-class-link'>
        ...
        <Link className='new-value-link' to='/NewCoreValue'><img src="lib/assets/creativity.svg" className='img-new-value' width='25px' height='25px' alt="core value icon" />New Core Value</Link>
      </div>
    </div>
  );
