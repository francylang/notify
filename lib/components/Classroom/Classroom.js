...
const Classroom = ({ teacher, students, deleteStudent, userStatus, coreValues, resetCount, returnIfValueHasCount }) => {
  ...
  return (
    <div>
      <div className='teacher-and-summary'>
        ...
        <button className='summary-button' onClick= { () => resetCount() }>Reset</button>
      </div>
