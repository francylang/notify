...
const Classroom = ({ teacher, students, deleteStudent, userStatus, sendSummaries, coreValues, plusOneCoreValue }) => {
  if (userStatus === false) {
  ...
  return (
    <div>
        ...
        {/* <button onClick= { () => sendSummaries(student, total) }>Send Summaries</button> */}
