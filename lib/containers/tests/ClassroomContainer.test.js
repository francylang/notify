...
describe('classroom of teacher and students', () => {
  ...
  it('should have a default state', () => {
    const wrapper = mount(<Classroom
                            students={
                              [{ id: 5, name: 'Francy Lang', parentContact: 'Pam Lang', phone: '5029052136'}]
                            }/>);

    expect(wrapper.instance().props.students).toEqual();
    // expect(wrapper.instance().props.teacher).toEqual({});
  });
