...
describe('actions', () => {
  ...
  it('should authenticate user logins', () => {
    const expectedAction = {
      type: 'CHECK_AUTHENTICATION',
      user: { email: 'Francy.Lang@gmail.com', password: 'password' }
    };

    expect(actions.isAuthenticated({ email: 'Francy.Lang@gmail.com', password: 'password' })).toEqual(expectedAction);
  });
